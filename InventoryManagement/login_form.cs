    ...
    public partial class login_form : Form
    {
        ...
        private void button_WOC1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                com.CommandText = "select username,password from login "+ "WHERE username = '" + uname + "' AND password = '" + pass + "'";
                com.Connection = con;
                ...
                {
                    MessageBox.Show("Login successfull !", "Success!", MessageBoxButtons.OK,
                        MessageBoxIcon.Exclamation);
                   
                    this.Hide();
                    //Form1.label.Text = "You are currently logged in as " + uname;
